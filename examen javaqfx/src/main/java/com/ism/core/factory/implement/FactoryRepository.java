...
import com.ism.data.repository.implement.listachatRepository;
...
public class FactoryRepository implements IFactoryRepository {
    ...
    @Override
    public IlistachatRepository getInstancelistachatRepository() {
        return listachatRepository == null ? new listachatRepository() : listachatRepository;
    }
