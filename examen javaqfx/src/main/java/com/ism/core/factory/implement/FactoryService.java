...
import com.ism.services.implement.listachatService;
...
public class FactoryService implements IFactoryService {
    ...
    @Override
    public IlistachatService getInstancelistachatService() {
        return listachatService == null ? new listachatService(factoryRepository.getInstancelistachatRepository()) : listachatService;
    }
