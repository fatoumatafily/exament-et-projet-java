...
import com.ism.controllers.implement.listachatView;
...
public class FactoryView implements IFactoryView {
    ...
    @Override
    public IlistachatView getInstancelistachatView() {
        return listachatView == null ? new listachatView() : listachatView;
    }
